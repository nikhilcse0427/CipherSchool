...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>CipherStudio - Online React IDE</title>
        <meta name="description" content="Build React applications in your browser" />
        ...
        <main className="container mx-auto px-6 py-20">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="flex justify-center space-x-4">
              ...
              <Link href="/login" className="bg-white text-primary-600 px-8 py-4 rounded-lg text-lg font-semibold hover:bg-gray-50 transition border-2 border-primary-600">
                Sign In
              </Link>
            </div>
          </div>
